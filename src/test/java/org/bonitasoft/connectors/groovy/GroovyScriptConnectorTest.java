...
import org.bonitasoft.connectors.groovy.GroovyScriptConnector;
...
public class GroovyScriptConnectorTest {
    ...
    public void execute_should_use_a_dependency() throws Exception {
        final List<List<Object>> context = new ArrayList<>();
        final List<Object> var1 = new ArrayList<>();
        var1.add("count");
        var1.add(83);
        context.add(var1);
    ...
    public void execute_should_use_the_current_class_loader() throws Exception {
        ...
        try {
            ...
            final GroovyScriptConnector connector = buildConnector("SimpleAddition.addition(1, 23)",
